...
const Footer = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  $$result.css.add(css);
  return `<div class="w-full flex flex-col justify-between pt-20 relative z-50 bg-surface-900"><div class="w-full bg-primary-700 h-px"></div> <div class="flex container justify-evenly a svelte-32c85l" data-svelte-h="svelte-t67w6"><div class="flex flex-col gap-6 p-10 font-bold"><a class="hover:font-normal dark:text-white" href="/"><p>Home</p></a> <a class="hover:font-normal dark:text-white" href="/about"><p>About Us</p></a> <a class="hover:font-normal dark:text-white" href="/projects"><p>Projects</p></a> <a class="hover:font-normal dark:text-white" href="/members"><p>Members</p></a> <a class="hover:font-normal dark:text-white" href="/editorials"><p>Editorials</p></a> <a class="hover:font-normal dark:text-white" href="/calendar"><p>Calendar</p></a> <div><a class="bg-primary-500 py-2 px-4 w-auto rounded-full" href="https://docs.google.com/forms/d/e/1FAIpQLSdLTjL76KESHNkkE-H5BRoGimma8ja0H55lt1-8KsSIzirRdQ/viewform">Join Us</a></div></div> <div class="flex flex-col gap-5 p-10"><p class="p font-bold">CONTACT</p> <p class="p">pcsberkeley@gmail.com</p> <p class="p">University of California, Berkeley</p> <p class="p">Berkeley, CA</p></div></div> <div class="w-full bg-primary-700 h-px"></div> <div class="flex container justify-around pt-6 svelte-32c85l"><p class="p text-center" data-svelte-h="svelte-nj8rr0">Copyright @ 2024 Political Computer Science @ Berkeley. All rights reserved</p> <div class="flex flex-row justify-center items-center gap-8"><a href="https://www.instagram.com/pcs_berkeley/" target="blank">${validate_component(Fa, "Fa").$$render(
    $$result,
    {
