...
const IconCard = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="flex flex-col gap-5 bg-secondary-100 dark:bg-surface-600 rounded-xl p-8 hover:bg-primary-200 items-start dark:hover:bg-primary-700 h-full flex-1 duration-300"><div class="bg-primary-700 m-auto rounded-md p-4">${validate_component(Fa, "Fa").$$render($$result, { class: "h3 p-0 dark:text-white", icon }, {}, {})}</div> <h1 class="h3 text-left font-bold">${escape(header)}</h1> <h4 class="p dark:text-white text-left leading-7">${escape(message)}</h4></div>`;
});
const EventCard = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="flex flex-col gap-5 bg-secondary-100 dark:bg-surface-600 rounded-xl hover:bg-primary-200 items-start dark:hover:bg-primary-700 flex-1 duration-300 overflow-hidden"><div class="w-full"><img class="overflow-hidden"${add_attribute("src", img, 0)}${add_attribute("alt", title, 0)}></div> <div class="flex justify-end flex-col gap-6 px-8 pb-8 h-full"><h2 class="h3 dark:text-white font-bold">${escape(title)}</h2> <h3 class="p text-primary-400">${escape(timeInfo)}</h3> <p class="p">${escape(description)}</p></div> </div>`;
});
const css = {
...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="flex ab flex-col px-10 svelte-rces83">${validate_component(Fade, "Fade").$$render($$result, {}, {}, {
    default: () => {
      return `<div class="flex flex-col gap-7" data-svelte-h="svelte-1m7glyx"> <h4 class="h4 text-primary-500 smallHeader svelte-rces83">About Us</h4> <h1 class="text-6xl text-center font-bold">Our Mission Statement</h1> <div class="flex px-10"><p class="h5 text-secondary-500 dark:text-secondary-100 leading-10 text-center">Political Computer Science strives to better understand the intersection of policy and
