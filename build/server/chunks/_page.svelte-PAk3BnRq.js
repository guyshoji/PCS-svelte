import { c as create_ssr_component, v as validate_component, i as each, a as add_attribute, e as escape, j as is_promise, n as noop, d as subscribe, o as onDestroy, s as setContext, k as get_store_value, g as getContext, l as compute_rest_props, p as get_current_component, q as set_current_component, r as run_all, t as current_component } from './ssr-8MCLeM_r.js';
import { S as SceneGraphObject, T, r as revision, u as useThrelte, c as createRawEventDispatcher, a as useParent } from './TiltDivider.svelte_svelte_type_style_lang-2iRBUjmW.js';
import { d as derived, w as writable, r as readable } from './index-wmGxQCnP.js';
import { Scene, ColorManagement, PCFSoftShadowMap, ACESFilmicToneMapping, Vector2, Raycaster, PerspectiveCamera, WebGLRenderer, sRGBEncoding, LinearEncoding } from 'three';
...
import { F as Fade, a as Footer } from './Footer-J0UkeKLz.js';
...
const Typewriter = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  const modes = {
    concurrent: () => import('./concurrent-ZF8-uxJL.js'),
    cascade: () => import('./cascade-jZ5O_Bb2.js'),
    loop: () => import('./loop-24CoPwQg.js'),
    loopOnce: () => import('./loopOnce-k0Vqk8nr.js'),
    loopRandom: () => import('./loopRandom-NjbdopSU.js'),
    scramble: () => import('./scramble-b9IdmwzQ.js')
  };
...
const css$1 = {
  code: ".custom-shape-divider-bottom-1705252340.svelte-sohcrx.svelte-sohcrx{position:absolute;bottom:0;left:0;width:100%;overflow:hidden;line-height:0;transform:rotate(180deg)}.custom-shape-divider-bottom-1705252340.svelte-sohcrx svg.svelte-sohcrx{position:relative;display:block;width:calc(100% + 1.3px);height:150px}.custom-shape-divider-bottom-1705252340.svelte-sohcrx .shape-fill.svelte-sohcrx{fill:rgba(var(--color-surface-900))}",
  map: null
};
...
//# sourceMappingURL=_page.svelte-PAk3BnRq.js.map
