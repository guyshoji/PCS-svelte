...
<div class="w-full h-screen relative z-10">
	<div class="typewriter select-none flex flex-col gap-20 pl-16 justify-center items-center">
		<Fade>
			<div class="flex flex-col gap-6 justify-center items-start text-left">
				...
				<a
					class="bg-primary-600 text-center font-bold flex cursor-pointer rounded-full px-4 py-2 hover:bg-primary-500 duration-200"
